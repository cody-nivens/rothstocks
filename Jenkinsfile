node {
    ...
    stage("Deploy"){
        ...
        sh "sleep 15"
        sh "kubectl set image deployment/railsapp-deployment --namespace default railsapp=127.0.0.1:30400/rothstocks:latest"
        sh "kubectl set image deployment/railsapp-deployment --namespace default railsapp=127.0.0.1:30400/rothstocks"
    }
}
